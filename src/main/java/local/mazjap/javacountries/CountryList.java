...
public class CountryList {
    ...
    public Country getCountryByName(String name) {
        for (Country country : countryList) {
            if (country.getName().toLowerCase().equals(name.toLowerCase())) return country;
        }
        return null;
    }

    public ArrayList<Country> getCountryByLetter(char c) {
        ArrayList<Country> countries = new ArrayList<>();
        for (Country country : countryList) {
            if (c == country.getName().toLowerCase().charAt(0) || c == country.getName().charAt(0)) {
